...
function handleConnectDisconnect(event, connected){
    const controllerAreaUnconnected = document.getElementById(
        "unconnectedArea"
    );
...
function handleRumble(gamepad) {
    const rumbleOnButtonPress = document.getElementById("rumble");
